...
![3-1Q119101429D6](uploads/a2e26a3595fc93434f421eefdbff764d/3-1Q119101429D6.gif)  
...
访问者（Visitor）模式是使用频率较高的一种[设计模式](https://gitlab.com/superxzl/way-api/wikis/设计模式/设计模式)，它常常同以下两种设计模式联用。
