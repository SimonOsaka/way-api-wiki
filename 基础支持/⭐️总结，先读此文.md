...
| 开发协作 | Confluence | 多人文档协作，有大量的插件资源，可以与钉钉进行关联 |[wiki.js](https://github.com/Requarks/wiki)优先使用|
| 开发管理 | Jira | 项目管理，有大量插件资源，可以与钉钉进行关联 ||
| 数据库 | MySQL5.7 | 数据库管理系统 | PostgreSQL如果团队不保守就用这个。 |
...
| 运维服务                  | 软件                                                 | 描述                                                         | 替代软件                                                     |
| ------------------------- | ---------------------------------------------------- | ------------------------------------------------------------ | :----------------------------------------------------------- |
| 服务器OS                  | Ubuntu Server                                        | Redhat的开源版本，只去商标文字。使用版本7                    | Rocky Linux                                   |
| CMDB资产管理              |                                                      |                                                              |                                                              |
